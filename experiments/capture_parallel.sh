...
sudo ifup eth0
echo "Correlate"
parallel --xapply ../src/correlate.py "${CORX_PATH}/${DATE}_rx{1}.corx" "${CORX_PATH}/${DATE}_rx{2}.corx" -o "${CORRS_PATH}/corr_${DATE}_$1_{1}-{2}.npz" ::: 0 0 0 1 1 2 ::: 1 2 3 2 3 3 >${LOG_PATH}/corr_${DATE}_$1.log
